 ...
 * @author fantim
 */
public class ITResourceUtilities {
    static Log logger = LogFactory.getLog(ITResourceUtilities.class);

	private com.thortech.xl.dataaccess.tcDataProvider isDataBase;
	 ...
	 */
	public ITResourceUtilities(com.thortech.xl.dataaccess.tcDataProvider dataBase) throws tcAPIException {
			isDataBase = dataBase;
     ...
     * @param _itrIntf
     */
    public ITResourceUtilities(tcITResourceInstanceOperationsIntf _itrIntf) {
        itrIntf = _itrIntf;
    }
    ...
    public static Hashtable findNameValuePairsForITResourceInstance(
        ...
        Hashtable ht[] = ITResourceUtilities.getITResourceInstanceParameters(
                itResources, key);
