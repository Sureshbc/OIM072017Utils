...
public class UserSearch {
	...
	public UserSearch(String userName, String password, String URL) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		UserSearch test = new UserSearch("xelsysadm", "Demo1234", "t3://oiam11g:14000/");
	...
	protected void execute() throws Exception {
		...
		umgr = userClient.getUserManager();

		/*
		 * Create a SearchCriteria
		 */

		// criteria = new SearchCriteria("First Name", "John",
		// SearchCriteria.Operator.EQUAL);
		// criteria = new SearchCriteria("Email", "John.Wayne@openptk.org",
		// SearchCriteria.Operator.EQUAL);
		// criteria = new SearchCriteria("First Name", "scott",
		// SearchCriteria.Operator.EQUAL);
		// criteria = new SearchCriteria("usr_key", "*",
		// SearchCriteria.Operator.EQUAL);
		criteria = new SearchCriteria("User Login", "mfanti", SearchCriteria.Operator.EQUAL);

		/*
		 * What attributes to return if null / empty, all attributes are
		 * returned
		 */
		...
		if (users != null && !users.isEmpty()) {
			LOGGER.info("search results, quantity=" + users.size());
			for (User user : users) {
				...
				LOGGER.info("EntityId: " + user.getEntityId() + ", Id: " + user.getId() + ", Attributes: "
						+ buf.toString());
			}
		} else {
